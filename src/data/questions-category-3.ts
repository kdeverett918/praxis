...
export const category3Questions: QuestionData[] = [
...

  {
    ...
    options: [
      { id: 'a', text: 'The goal should be supported by standardized assessment data', isCorrect: false },
      { id: 'b', text: 'The goal should identify a precise, observable behavior the client will perform', isCorrect: true },
      { id: 'c', text: 'The goal should be structured in a sequential hierarchy', isCorrect: false },
      { id: 'd', text: 'The goal should be sensitive to cultural and linguistic differences', isCorrect: false },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Strengthen the tongue base against the posterior pharyngeal wall', isCorrect: false },
      { id: 'b', text: 'Prolong and elevate hyolaryngeal excursion to improve UES opening', isCorrect: true },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'School-age children who stutter with concomitant language delays', isCorrect: false },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: 'Maximum expiratory pressure, cough effectiveness, and swallowing safety', isCorrect: true },
    ...
    clinicalSetting: null,
    referenceSources: ['Pitts, T., et al. (2009). Impact of EMST on voluntary cough and swallow function in Parkinson disease'],
  },
  {
    id: 'c3-q007',
  ...
  },
  {
    ...
    clinicalSetting: null,
    referenceSources: ['Fujiu, M., & Logemann, J.A. (1996). Effect of a tongue-holding maneuver on posterior pharyngeal wall movement'],
  },
...

  {
    ...
    options: [
      { id: 'a', text: 'Resonant voice therapy with semi-occluded vocal tract exercises', isCorrect: false },
      { id: 'b', text: 'LSVT LOUD delivered as 16 sessions over 4 consecutive weeks', isCorrect: true },
      { id: 'c', text: 'Pitch glides and vocal range expansion exercises 3 times per week', isCorrect: false },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'The child will improve final consonant production in conversation', isCorrect: false },
      { id: 'b', text: 'Given minimal pair activities, the child will produce final consonants in CVC words with 80% accuracy across 3 consecutive sessions', isCorrect: true },
      { id: 'c', text: 'The child will produce /t, d, n/ in all word positions within 6 months', isCorrect: false },
      { id: 'd', text: 'The child will demonstrate awareness of final consonants by pointing to correct pictures', isCorrect: false },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: '"It starts with /h/. It rhymes with glamour. Say hammer."', isCorrect: false },
      { id: 'b', text: '"What group does it belong to? What does it look like? What do you use it for? Where do you find it?"', isCorrect: true },
      { id: 'c', text: '"Point to the hammer. Now say the word three times quickly."', isCorrect: false },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'A comprehensive speech-generating device with dynamic display and robust vocabulary', isCorrect: false },
      { id: 'b', text: 'Picture Exchange Communication System (PECS) beginning at Phase I', isCorrect: true },
      { id: 'c', text: 'A low-tech communication board with 50+ symbols organized by category', isCorrect: false },
      { id: 'd', text: 'Sign language instruction focusing on 20 core vocabulary signs', isCorrect: false },
    ],
    explanation:
    ...
    referenceSources: ['Bondy, A., & Frost, L. (2001). PECS Training Manual', 'ASHA Practice Portal: AAC'],
  },
  {
    id: 'c3-q014',
    ...
    options: [
      { id: 'a', text: 'Melodic Intonation Therapy to improve verbal output length', isCorrect: false },
      { id: 'b', text: 'Script training using personalized restaurant ordering scripts', isCorrect: true },
      { id: 'c', text: 'Confrontation naming of food items using a semantic cueing hierarchy', isCorrect: false },
    ...
    clinicalSetting: 'outpatient rehabilitation',
    referenceSources: ['Cherney, L.R., et al. (2008). Script training: An approach to aphasia treatment'],
  },
  {
    id: 'c3-q015',
    ...
    bigNine: ['feeding_swallowing'],
    difficulty: 'application',
    tags: ['head rotation', 'compensatory strategy', 'pharyngeal residue', 'FEES', 'unilateral weakness'],
    clinicalSetting: 'acute care hospital',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: 'Traditional articulation approach with phonetic placement', isCorrect: false },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Parents drill 10 target words daily using flashcards and imitation prompts', isCorrect: false },
      { id: 'b', text: 'Parents follow the child\'s lead, wait for communication attempts, and respond by adding language', isCorrect: true },
      { id: 'c', text: 'Parents withhold desired items to force verbal requests', isCorrect: false },
      { id: 'd', text: 'Parents use structured ABA discrete trial training during play', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['receptive_expressive'],
    difficulty: 'application',
    tags: ['Hanen', 'It Takes Two to Talk', 'parent-mediated', 'language delay', 'early intervention'],
    clinicalSetting: 'early intervention',
  ...
  },
  {
    ...
    clinicalSetting: 'outpatient rehabilitation',
    referenceSources: ['Doyle, P.C. (2005). Clinical procedures for training use of the electrolarynx'],
  },
  {
    id: 'c3-q019',
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Parents deliver verbal contingencies for stutter-free speech', isCorrect: false },
      { id: 'b', text: 'The clinician teaches prolonged speech that the client self-rates and adjusts for naturalness', isCorrect: true },
      { id: 'c', text: 'Desensitization through voluntary stuttering and pseudostuttering exercises', isCorrect: false },
      { id: 'd', text: 'Cognitive restructuring of negative attitudes about communication', isCorrect: false },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'The patient generates agent-verb-patient thematic role combinations for target verbs and answers related semantic questions', isCorrect: true },
      { id: 'b', text: 'The patient names pictures of actions and describes the steps involved in each action', isCorrect: false },
      { id: 'c', text: 'The patient practices repeating verb phrases with increasing length and complexity', isCorrect: false },
      { id: 'd', text: 'The patient matches written verbs to corresponding pictures in a timed task', isCorrect: false },
    ],
    explanation:
    ...
    clinicalSetting: 'outpatient rehabilitation',
    referenceSources: ['Edmonds, L.A., et al. (2009). VNeST: A new approach to treating lexical retrieval in aphasia'],
  },
  {
    id: 'c3-q023',
    ...
    options: [
      { id: 'a', text: 'The SLP provides auditory bombardment with the target words followed by repeated imitation', isCorrect: false },
      { id: 'b', text: 'The SLP uses tactile-kinesthetic cues on the face, jaw, and lips to guide the child\'s articulatory movements', isCorrect: true },
      { id: 'c', text: 'The SLP teaches the child phonological awareness skills to support self-correction', isCorrect: false },
      { id: 'd', text: 'The SLP uses a visual biofeedback system showing real-time acoustic spectrograms', isCorrect: false },
    ],
    explanation:
    ...
    referenceSources: ['Hayden, D.A. (2006). The PROMPT model: Use and application for children with mixed phonological-motor impairment'],
  },
  {
    id: 'c3-q024',
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Post visual cue cards at the bedside and train nursing staff to provide verbal reminders during meals', isCorrect: true },
      { id: 'b', text: 'Teach the patient the Mendelsohn maneuver as a more effective alternative', isCorrect: false },
      { id: 'c', text: 'Discontinue the chin tuck recommendation since the patient cannot consistently use it', isCorrect: false },
      { id: 'd', text: 'Write a treatment goal for the patient to independently perform chin tuck in 80% of swallows', isCorrect: false },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Patients are encouraged to use any modality—speech, writing, gesture, or drawing—to communicate', isCorrect: false },
      { id: 'b', text: 'Patients must use verbal speech and are constrained from compensating with gesture or writing', isCorrect: true },
      { id: 'c', text: 'Patients practice individual computer-based language exercises for 30 minutes per session', isCorrect: false },
      { id: 'd', text: 'Patients receive melodic intoning to facilitate word retrieval during card-request activities', isCorrect: false },
    ],
    explanation:
...

  {
    ...
    options: [
      { id: 'a', text: 'Auditory comprehension drills and confrontation naming tasks', isCorrect: false },
      { id: 'b', text: 'Direct attention training paired with metacognitive strategy instruction for problem-solving in functional contexts', isCorrect: true },
      { id: 'c', text: 'Written expression exercises with grammar correction feedback', isCorrect: false },
      { id: 'd', text: 'Social skills group focused on conversational turn-taking', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['cognitive_communication'],
    difficulty: 'analysis',
    tags: ['TBI', 'cognitive-communication', 'attention training', 'metacognitive strategies', 'executive function'],
    clinicalSetting: 'outpatient rehabilitation',
    referenceSources: ['Sohlberg, M.M., & Mateer, C.A. (2001). Cognitive Rehabilitation: An Integrative Neuropsychological Approach'],
  },
  {
    id: 'c3-q028',
    ...
    options: [
      { id: 'a', text: 'The study provides strong evidence because tongue strength improved significantly', isCorrect: false },
      { id: 'b', text: 'The study provides limited evidence due to lack of control group, small sample, and absence of functional swallowing outcome measures', isCorrect: true },
      { id: 'c', text: 'The study provides no evidence and should be disregarded entirely', isCorrect: false },
      { id: 'd', text: 'The study is adequate evidence to change clinical practice because it showed statistically significant results', isCorrect: false },
    ],
    explanation:
    ...
    clinicalSetting: null,
    referenceSources: ['Dollaghan, C.A. (2007). The Handbook for Evidence-Based Practice in Communication Disorders'],
  },
  {
    id: 'c3-q029',
    ...
    options: [
      { id: 'a', text: 'Reduce the grid to 20 locations to simplify navigation in the new environment', isCorrect: false },
      { id: 'b', text: 'Switch from the SGD to a low-tech communication board to reduce classroom distraction', isCorrect: false },
      { id: 'c', text: 'Program curriculum-relevant vocabulary for each subject and train teachers on communication partner strategies', isCorrect: true },
      { id: 'd', text: 'Remove the SGD from classroom use and focus on writing as the primary communication mode', isCorrect: false },
    ],
    explanation:
    ...
    clinicalSetting: 'school-based',
    referenceSources: ['ASHA Practice Portal: AAC', 'Beukelman, D.R., & Light, J.C. (2020). Augmentative and Alternative Communication'],
  },
  {
    id: 'c3-q030',
    ...
    options: [
      { id: 'a', text: 'Focus exclusively on intensive strengthening exercises to slow the disease progression', isCorrect: false },
      { id: 'b', text: 'Defer treatment until symptoms worsen since the patient is currently functional', isCorrect: false },
      { id: 'c', text: 'Implement proactive planning: introduce compensatory swallowing strategies now, establish AAC baseline and begin device exploration, and develop a staged plan for anticipated decline', isCorrect: true },
      { id: 'd', text: 'Recommend immediate PEG tube placement to prevent aspiration pneumonia', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['feeding_swallowing', 'aac', 'speech_sound'],
    difficulty: 'analysis',
    tags: ['ALS', 'progressive disease', 'proactive planning', 'AAC', 'dysphagia', 'voice banking'],
    clinicalSetting: 'outpatient neurology clinic',
    referenceSources: ['ASHA Practice Portal: ALS', 'Yorkston, K.M., et al. (2010). Management of Motor Speech Disorders in Children and Adults'],
  },
  {
    id: 'c3-q031',
    ...
    options: [
      { id: 'a', text: 'Fluency shaping techniques only, since addressing emotional reactions might increase the child\'s awareness of stuttering', isCorrect: false },
      { id: 'b', text: 'An integrated approach combining fluency management strategies with desensitization activities and affective components addressing the child\'s feelings and avoidance', isCorrect: true },
      { id: 'c', text: 'Referral to psychology with no direct speech treatment until emotional issues are resolved', isCorrect: false },
      { id: 'd', text: 'Parent counseling only, since direct treatment of stuttering at age 5 may cause negative self-awareness', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['fluency'],
    difficulty: 'analysis',
    tags: ['stuttering', 'integrated treatment', 'secondary behaviors', 'avoidance', 'desensitization'],
    clinicalSetting: 'private practice',
    referenceSources: ['Guitar, B. (2019). Stuttering: An Integrated Approach to Its Nature and Treatment'],
  },
  {
    id: 'c3-q032',
    ...
    options: [
      { id: 'a', text: 'Target conversational speech through structured dialogue with specific vocabulary targets', isCorrect: false },
      { id: 'b', text: 'Focus on auditory comprehension of single words and simple commands using multimodal input, with environmental management strategies for communication partners', isCorrect: true },
      { id: 'c', text: 'Begin VNeST protocol with 10 target verbs to improve word retrieval', isCorrect: false },
      { id: 'd', text: 'Implement CIAT with 3 hours per day of verbal-only communication activities', isCorrect: false },
    ],
    explanation:
    ...
    clinicalSetting: 'inpatient rehabilitation',
    referenceSources: ['Chapey, R. (2008). Language Intervention Strategies in Aphasia and Related Neurogenic Communication Disorders'],
  },
  {
    id: 'c3-q033',
    ...
    options: [
      { id: 'a', text: 'A 9-year-old with an articulation disorder who produces /r/ correctly in structured activities at 90% but at 40% in conversation', isCorrect: false },
      { id: 'b', text: 'A 7-year-old with a history of expressive language disorder whose standardized scores are now within normal limits and who participates effectively in classroom instruction without support', isCorrect: true },
      { id: 'c', text: 'A 10-year-old who stutters with 3% syllables stuttered in clinic but 12% in the classroom, who reports anxiety about oral presentations', isCorrect: false },
      { id: 'd', text: 'An 8-year-old with a language disorder whose standardized scores are now within normal limits but who continues to struggle with reading comprehension', isCorrect: false },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Discharge the patient since speaking voice has improved', isCorrect: false },
      { id: 'b', text: 'Continue voice therapy with added singing-specific exercises and coordinate with a singing voice specialist, while monitoring nodule regression', isCorrect: true },
      { id: 'c', text: 'Immediately refer for surgical excision of the remaining nodules', isCorrect: false },
      { id: 'd', text: 'Increase voice therapy to 5 days per week to accelerate nodule resolution', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['voice_resonance'],
    difficulty: 'analysis',
    tags: ['vocal nodules', 'voice therapy', 'singing voice', 'treatment modification', 'stroboscopy'],
    clinicalSetting: 'voice center',
    referenceSources: ['Stemple, J.C., et al. (2010). Clinical Voice Pathology: Theory and Management'],
  },
  {
    id: 'c3-q035',
    ...
    options: [
      { id: 'a', text: 'Choose Approach A because Level I evidence always takes precedence over lower-level evidence', isCorrect: false },
      { id: 'b', text: 'Choose Approach B because patient preference and values are more important than research evidence', isCorrect: false },
      { id: 'c', text: 'Integrate the strong evidence for Approach A with the patient\'s goals by discussing both options, their evidence bases, and how elements of each might address the patient\'s priorities', isCorrect: true },
      { id: 'd', text: 'Alternate between both approaches each session to cover both evidence and preference', isCorrect: false },
    ],
    explanation:
    ...
    clinicalSetting: null,
    referenceSources: ['Sackett, D.L., et al. (2000). Evidence-Based Medicine', 'ASHA Practice Portal: EBP'],
  },
  {
    id: 'c3-q036',
    ...
    options: [
      { id: 'a', text: 'Target final consonants because they are developmentally expected and will increase the number of distinct word shapes the child can produce, thereby expanding functional vocabulary', isCorrect: true },
      { id: 'b', text: 'Target early-developing vowel contrasts because vowels carry more acoustic energy and will improve intelligibility most rapidly', isCorrect: false },
      { id: 'c', text: 'Target multisyllabic words because they represent higher complexity and will accelerate overall development', isCorrect: false },
      { id: 'd', text: 'Target voice onset time distinctions for stop consonants to improve phonemic contrast', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['speech_sound', 'receptive_expressive'],
    difficulty: 'analysis',
    tags: ['Down syndrome', 'target selection', 'phonological development', 'final consonants', 'vocabulary expansion'],
    clinicalSetting: 'early intervention',
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Use only compensatory strategies since the patient is past the acute recovery window', isCorrect: false },
      { id: 'b', text: 'Use only rehabilitative exercises since the patient is cognitively intact and motivated', isCorrect: false },
      { id: 'c', text: 'Combine rehabilitative exercises to improve underlying physiology with compensatory strategies to ensure safety during the rehabilitation process', isCorrect: true },
      { id: 'd', text: 'Recommend a permanent modified diet since 4 months post-stroke leaves limited potential for improvement', isCorrect: false },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Receptive vocabulary expansion with tier 2 academic vocabulary', isCorrect: false },
      { id: 'b', text: 'Pragmatic language skills including figurative language comprehension, inferencing, and audience awareness', isCorrect: true },
      { id: 'c', text: 'Phonological awareness and decoding for reading improvement', isCorrect: false },
      { id: 'd', text: 'Mean length of utterance expansion through sentence combining', isCorrect: false },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Begin oral motor exercises to improve the patient\'s interest in eating', isCorrect: false },
      { id: 'b', text: 'Recommend thickened liquids and pureed diet to make meals easier', isCorrect: false },
      { id: 'c', text: 'Educate staff that the intake decline is likely related to disease progression rather than swallowing impairment, and collaborate on environmental and feeding modifications to support comfort and intake', isCorrect: true },
    ...
    clinicalSetting: 'skilled nursing facility',
    referenceSources: ['ASHA Practice Portal: Dementia', 'American Geriatrics Society (2014). Feeding tubes in advanced dementia position statement'],
  },
  {
    id: 'c3-q040',
    ...
    options: [
      { id: 'a', text: 'Level IV (Confused-Agitated): Focus on reducing stimulation, establishing consistent responses to simple commands, and training caregivers in communication strategies', isCorrect: true },
      { id: 'b', text: 'Level VI (Confused-Appropriate): Focus on memory strategies and community reintegration activities', isCorrect: false },
      { id: 'c', text: 'Level III (Localized Response): Focus on sensory stimulation to elicit purposeful responses', isCorrect: false },
      { id: 'd', text: 'Level VII (Automatic-Appropriate): Focus on higher-level cognitive-linguistic tasks for return to work', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['cognitive_communication'],
    difficulty: 'analysis',
    tags: ['TBI', 'Rancho Los Amigos', 'cognitive-communication', 'agitation', 'post-traumatic amnesia'],
    clinicalSetting: 'inpatient rehabilitation',
    referenceSources: ['Hagen, C. (1998). Rancho Levels of Cognitive Functioning', 'ASHA Practice Portal: TBI'],
  },
  {
    id: 'c3-q041',
    ...
    options: [
      { id: 'a', text: 'Move to three-syllable words since two-syllable accuracy is high with cueing', isCorrect: false },
      { id: 'b', text: 'Systematically fade the simultaneous production support through the DTTC cueing hierarchy—from simultaneous to slightly delayed to immediate repetition to independent', isCorrect: true },
      { id: 'c', text: 'Switch to a phonological awareness approach since the motor approach is not producing independent accuracy', isCorrect: false },
      { id: 'd', text: 'Add visual biofeedback technology to supplement the tactile cues', isCorrect: false },
    ],
    explanation:
    ...
    clinicalSetting: 'private practice',
    referenceSources: ['Strand, E.A., et al. (2006). Treatment of severe CAS: A treatment efficacy study'],
  },
...

  {
    ...
    options: [
      { id: 'a', text: 'Dedicate all 10 sessions exclusively to dysphagia treatment per the family\'s request', isCorrect: false },
      { id: 'b', text: 'Split sessions equally: 5 for dysphagia, 3 for cognitive-communication, 2 for neglect', isCorrect: false },
      { id: 'c', text: 'Address all three areas within each session by integrating neglect and cognitive strategies during mealtime-based dysphagia treatment, while educating the family on the interconnection of these deficits', isCorrect: true },
      { id: 'd', text: 'Focus on cognitive-communication since it underlies the other deficits, and defer dysphagia treatment until after discharge', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['feeding_swallowing', 'cognitive_communication'],
    difficulty: 'clinical_reasoning',
    tags: ['right CVA', 'left neglect', 'integrated treatment', 'resource allocation', 'family education'],
    clinicalSetting: 'inpatient rehabilitation',
    referenceSources: ['ASHA Practice Portal: Right Hemisphere Disorder', 'ASHA Practice Portal: Adult Dysphagia'],
  },
  {
    id: 'c3-q043',
    ...
    options: [
      { id: 'a', text: 'Conduct therapy in English only as the parents requested since they know their child best', isCorrect: false },
      { id: 'b', text: 'Conduct therapy in Spanish only since it is the home language and will provide the strongest foundation', isCorrect: false },
      { id: 'c', text: 'Educate the parents about the benefits of bilingual intervention, explain that treating in both languages supports both languages, and incorporate both Spanish and English targets based on the child\'s linguistic environments', isCorrect: true },
      { id: 'd', text: 'Refer to an English-only SLP since the parents want English intervention', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['receptive_expressive'],
    difficulty: 'clinical_reasoning',
    tags: ['bilingual', 'Spanish-English', 'language disorder', 'parent education', 'cultural competence'],
    clinicalSetting: 'pediatric outpatient',
    referenceSources: ['ASHA Practice Portal: Bilingual Service Delivery', 'Kohnert, K. (2010). Bilingual children with primary language impairment'],
  },
  {
    id: 'c3-q044',
    ...
    options: [
      { id: 'a', text: 'Begin aggressive oral trials with pureed food to motivate the patient and prevent learned non-use of swallowing muscles', isCorrect: false },
      { id: 'b', text: 'Develop a phased plan: Phase 1 targets trismus and range-of-motion exercises; Phase 2 introduces progressive oral trials as physiology improves; throughout, address xerostomia management and coordinate with the oncology team on radiation effects timeline', isCorrect: true },
      { id: 'c', text: 'Recommend permanent PEG dependency since base-of-tongue radiation typically causes irreversible dysphagia', isCorrect: false },
      { id: 'd', text: 'Focus solely on Mendelsohn maneuver repetitions since tongue base retraction is the primary deficit', isCorrect: false },
    ],
    explanation:
    ...
    referenceSources: ['Hutcheson, K.A., & Lewin, J.S. (2012). Functional outcomes after chemoradiation for advanced-stage HNC'],
  },
  {
    id: 'c3-q045',
    ...
    options: [
      { id: 'a', text: 'Simplify the AAC system to a low-tech board that is easier for the family to manage', isCorrect: false },
      { id: 'b', text: 'Focus remaining school sessions on academic vocabulary to maximize educational benefit', isCorrect: false },
      { id: 'c', text: 'Prioritize community and home integration: train family and community partners, program vocabulary for adult contexts (medical appointments, employment, social media), and connect with adult AAC support services', isCorrect: true },
      { id: 'd', text: 'Transfer AAC management to the family and discontinue school-based services to promote independence', isCorrect: false },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: 'Schedule a FEES for the following day to assess pharyngeal function around the endotracheal tube', isCorrect: false },
      { id: 'c', text: 'Decline the swallowing evaluation at this time, document that the patient is not an appropriate candidate due to current medical status, and recommend reassessment when the patient is extubated and alert', isCorrect: true },
      { id: 'd', text: 'Begin prophylactic oral motor exercises to maintain swallowing musculature while the patient is intubated', isCorrect: false },
    ],
    explanation:
    ...
    referenceSources: ['ASHA Practice Portal: Adult Dysphagia', 'Brodsky, M.B., et al. (2018). Screening for dysphagia in the ICU'],
  },
  {
    id: 'c3-q047',
    ...
    options: [
      { id: 'a', text: 'Discharge since stroboscopy is normal and in-clinic voice is functional', isCorrect: false },
      { id: 'b', text: 'Continue current therapy protocol for 6 more sessions and reassess', isCorrect: false },
      { id: 'c', text: 'Shift treatment focus to vocal load management and carryover strategies specific to the classroom environment, including voice amplification assessment, vocal dosing, and in-vivo practice during teaching', isCorrect: true },
      { id: 'd', text: 'Refer to ENT for possible botulinum toxin injection since behavioral therapy alone is insufficient', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['voice_resonance'],
    difficulty: 'clinical_reasoning',
    tags: ['MTD', 'voice therapy', 'carryover', 'vocal load', 'occupational voice use', 'amplification'],
    clinicalSetting: 'voice center',
    referenceSources: ['Verdolini, K., & Ramig, L.O. (2001). Review: Occupational risks for voice problems', 'Stemple, J.C., et al. (2010)'],
  },
  {
    id: 'c3-q048',
    ...
    options: [
      { id: 'a', text: 'Follow 3-step classroom directions with 80% accuracy and participate in small group discussions using complete sentences', isCorrect: false },
      { id: 'b', text: 'Follow 1-2 step directions in a structured environment with visual supports, orient to daily schedule using a visual planner, and use a written checklist to complete familiar classroom routines with aide cueing', isCorrect: true },
      { id: 'c', text: 'Write paragraph-length responses to reading comprehension questions and summarize main ideas from grade-level text', isCorrect: false },
      { id: 'd', text: 'Independently initiate conversations with peers and self-correct errors during oral presentations', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['cognitive_communication'],
    difficulty: 'clinical_reasoning',
    tags: ['TBI', 'Rancho Level V', 'school reentry', 'IEP', 'cognitive-communication', 'visual supports'],
    clinicalSetting: 'school-based',
    referenceSources: ['Hagen, C. (1998). Rancho Levels of Cognitive Functioning', 'Ylvisaker, M. (1998). Traumatic Brain Injury Rehabilitation: Children and Adolescents'],
  },
  {
    id: 'c3-q049',
    ...
    options: [
      { id: 'a', text: 'Continue single-word drill practice until accuracy reaches 95% before moving to phrases', isCorrect: false },
      { id: 'b', text: 'Transition to script training for work-specific phrases, incorporate contrastive stress and intonation practice, and explore AAC supplementation for complex communication demands', isCorrect: true },
      { id: 'c', text: 'Switch entirely to an AAC-only approach since speech will not meet occupational demands', isCorrect: false },
      { id: 'd', text: 'Discharge from speech therapy and recommend vocational counseling for a different career', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['speech_sound', 'aac'],
    difficulty: 'clinical_reasoning',
    tags: ['apraxia of speech', 'vocational rehabilitation', 'script training', 'prosody', 'multimodal communication'],
    clinicalSetting: 'outpatient rehabilitation',
    referenceSources: ['Wambaugh, J.L., et al. (2006). Treatment for acquired apraxia of speech', 'ASHA Practice Portal: Apraxia of Speech'],
  },
  {
    id: 'c3-q050',
    ...
    options: [
      { id: 'a', text: 'Discharge with a written diet card, weekly home health SLP visits, and a referral to a community aphasia group', isCorrect: false },
      { id: 'b', text: 'Discharge with a communication wallet containing key phrases and medical information, written and pictorial diet guidelines posted in the kitchen, trained daughter in dysphagia safety signs and communication strategies, home health SLP 2-3x/week initially with transition to outpatient aphasia treatment, and an emergency communication card in the patient\'s wallet', isCorrect: true },
      { id: 'c', text: 'Recommend extended inpatient stay until the patient can communicate independently and eat a regular diet', isCorrect: false },
      { id: 'd', text: 'Discharge with a home exercise program handout and follow-up in 3 months', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['cognitive_communication', 'feeding_swallowing'],
    difficulty: 'clinical_reasoning',
    tags: ['discharge planning', 'aphasia', 'dysphagia', 'home safety', 'caregiver training', 'multidisciplinary'],
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Immediately restrict to IDDSI Level 4 (Pureed) and Level 2 (Mildly Thick) liquids to eliminate all aspiration risk', isCorrect: false },
      { id: 'b', text: 'No intervention needed since the patient cleared the penetration with a spontaneous cough', isCorrect: false },
      { id: 'c', text: 'Implement EMST to improve hyolaryngeal excursion and cough strength, Shaker exercise for UES opening, effortful swallow for tongue base retraction, and trial chin tuck with thin liquids; monitor with follow-up instrumental assessment in 8 weeks; maintain current diet with compensatory strategy use', isCorrect: true },
      { id: 'd', text: 'Focus exclusively on LSVT LOUD since this will improve all oral motor function in Parkinson disease', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['feeding_swallowing'],
    difficulty: 'clinical_reasoning',
    tags: ['Parkinson disease', 'MBSS', 'instrumental findings', 'EMST', 'Shaker', 'treatment planning'],
    clinicalSetting: 'outpatient rehabilitation',
    referenceSources: ['Logemann, J.A. (1998)', 'Troche, M.S., et al. (2010). Aspiration and swallowing in Parkinson disease'],
  },
  {
    id: 'c3-q052',
    ...
    options: [
      { id: 'a', text: 'Agree with the teacher and discharge the student since standardized scores have improved significantly', isCorrect: false },
      { id: 'b', text: 'Continue the same treatment protocol since scores are still below the 25th percentile', isCorrect: false },
      { id: 'c', text: 'Shift treatment goals to address the language underpinnings of literacy—targeting reading comprehension strategies, written language organization, and metalinguistic skills—and educate the teacher about the language basis of reading and writing difficulties', isCorrect: true },
      { id: 'd', text: 'Transfer the student to the reading specialist and discontinue speech-language services', isCorrect: false },
    ],
    explanation:
    ...
    bigNine: ['receptive_expressive'],
    difficulty: 'clinical_reasoning',
    tags: ['language learning disability', 'literacy', 'reading comprehension', 'written expression', 'scope of practice'],
    clinicalSetting: 'school-based',
    referenceSources: ['ASHA Practice Portal: Written Language Disorders', 'Ehren, B.J. (2000). Maintaining a therapeutic focus and sharing responsibility for student success'],
  },
  {
    id: 'c3-q053',
    stem: 'Melodic Intonation Therapy (MIT) is MOST appropriate for a patient with which of the following profiles?',
    options: [
      { id: 'a', text: 'Severe Wernicke aphasia with fluent jargon and poor auditory comprehension', isCorrect: false },
      { id: 'b', text: 'Severe nonfluent aphasia with limited verbal output but relatively preserved auditory comprehension and good motivation', isCorrect: true },
      { id: 'c', text: 'Mild anomic aphasia with occasional word-finding difficulty in conversation', isCorrect: false },
      { id: 'd', text: 'Transcortical motor aphasia with intact repetition but limited spontaneous output', isCorrect: false },
    ],
    explanation:
    ...
    clinicalSetting: 'outpatient rehabilitation',
    referenceSources: ['Albert, M.L., Sparks, R.W., & Helm, N.A. (1973). Melodic intonation therapy for aphasia'],
  },
  {
    id: 'c3-q054',
    stem: 'The supraglottic swallow maneuver involves which sequence of steps?',
    options: [
      { id: 'a', text: 'Inhale, hold breath, swallow while holding breath, cough immediately after the swallow, swallow again', isCorrect: true },
      { id: 'b', text: 'Bear down, hold the Valsalva, swallow, exhale forcefully', isCorrect: false },
      { id: 'c', text: 'Tuck chin, hold breath, swallow twice, exhale', isCorrect: false },
      { id: 'd', text: 'Squeeze all swallowing muscles as hard as possible during the swallow, then clear throat', isCorrect: false },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: 'Phase V — Using PECS to comment on items in the environment', isCorrect: false },
